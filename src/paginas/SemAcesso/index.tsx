...
const SemAcesso = ({ logado, cargo }: AuthPaginas) => {
  ...
  return (
    <FundoBolhas>
      ...
      <h1 className="bg-linear-to-br from-[#ef4444] to-[#f59e0b] bg-clip-text text-transparent text-[80px] md:text-[120px] font-extrabold leading-none mb-4">
        403
      </h1>
      ...
      <p className="text-(--text-secondary) text-[15px] md:text-[16px] leading-normal mb-8">
        Desculpe, você não tem permissão para acessar este recurso. Verifique
